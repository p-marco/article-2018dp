...
\caption{\label{tab:unnamed-chunk-5}Syntactic differencies amongst overt/covert D languages}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{50%}>{\raggedright}X>{\raggedright}X}
\toprule
  & Overt D & Covert D\\
\midrule
...
\caption{\label{tab:unnamed-chunk-6}Amount of data in the collection}
\centering
