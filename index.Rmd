...
|          | Texts                                                                   | Tokens                                                                                | Lemma |
|----------|-------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------|
| Czech-IT | `r toString(nrow(df.czechit.ces))` ; `r toString(nrow(df.czechit.slk))` | `r toString(cleanCorpus(df.czechit.ces))` ; `r toString(cleanCorpus(df.czechit.slk))` |       |
| Merlin   | `r toString(nrow(df.merlin.ces))` ; `r toString(nrow(df.merlin.slk))`   | `r toString(cleanCorpus(df.merlin.ces))` ; `r toString(cleanCorpus(df.merlin.slk))`   | &lt;- |
| Valico   | `r toString(nrow(df.valico.ces))` ; `r toString(nrow(df.valico.slk))`   | `r toString(cleanCorpus(df.valico.ces))` ; `r toString(cleanCorpus(df.valico.slk))`   |       |
