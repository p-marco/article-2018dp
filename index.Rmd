...
Then, the amounts of the clusters in the dataset have beeen weighted by their absolute distribution and refactored to a value equal to 1. The plot in Figure \@ref(img:2gramTotal) shows the fine-grained comparison of these clusters in the dataset. 
