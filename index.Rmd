...
Czech (`ces`) and Slovak (`slk`) are languages of the Slavic branch in the Indo-european family. Alongside a certain morphological complexity in noun declension systems, these languages --except for Bulgarian (\@ref(exm:dpBul)) and Macedonian [@wals-37 in @wals]-- don't show an overt realization of the Determiner position inside the noun phrase (\@ref(exm:dpNo)) [@harkins1953]. 
...
(@) Proclitic (\#exm:dpPre)  
	...
	a. 	`fro` [@dedole2008 3261]  
		...
		\glt 	"The *dame* is in front to the room"
