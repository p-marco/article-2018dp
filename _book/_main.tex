...
\StringTok{    }\KeywordTok{geom_bar}\NormalTok{( }\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Corpora"}\NormalTok{, }\DataTypeTok{y=}\StringTok{"Number of texts in the collection"}\NormalTok{, }\DataTypeTok{color=}\StringTok{"Native Language"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\toprule
& Texts & Tokens & Lemma\tabularnewline
\midrule
\endhead
Czech-IT & 212 ; 74 & 11130 ; 4441 &\tabularnewline
Merlin & 1 ; 0 & 257 ; 1 & \textless{}-\tabularnewline
Valico & 107 ; 17 & 16251 ; 3317 &\tabularnewline
\bottomrule
\end{longtable}
