\documentclass[a4paper,twoside,12pt,chapterprefix=false,bibliography=totocnumbered,listof=flat]{scrartcl}
\usepackage{lmodern}
...
\section{The development of corpus}\label{the-development-of-corpus}

\section{Case Study: The usage of
DET}\label{case-study-the-usage-of-det}
