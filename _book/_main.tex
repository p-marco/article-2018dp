...
top of different theories inside the Generative framework on the status
of DP and NP. The section \ref{sec:caseStudy} is twofold: firstly I
present the methods used into the current analysis in terms of
\emph{reproducibility} of the research, the policies of data-collection
and an analysis of the expected results; while the second subsection is
...
One of the main areas of research in Generative studies on Second
Language Acquisition (\texttt{GenSLA}) regards the investigation of how
the linguistic structures can be accessed in L2.
