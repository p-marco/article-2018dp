...
linguistic structures which are not overtly show in L1 can be accessed
during the acquisition of a target language which show them. While doing
...
The section X provides a theoretical discussion on the top of different
theories inside the Generative framework on the status of DP and NP. The
section Y is a review of the methods used into the current analysis, in
terms of \emph{reproducibility} of the research itself, the policies of
data-collection and the explanation of the results. The section W
represent a case study made off to test some hypotheses about the
categorial differences of DPs during the acquisition.
